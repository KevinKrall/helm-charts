...
{{- default (include "urlshortener.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "urlshortener.postgresql.name" -}}
...
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "urlshortener.postgresql.fullname" -}}
...
*/}}
{{- define "urlshortener.djangoDatabasePassword" -}}
- name: DATABASE_PASSWORD
  valueFrom:
    secretKeyRef:
      name: {{ include "urlshortener.postgresql.fullname" . }}
